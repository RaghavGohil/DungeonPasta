...
g++ -c ../src/engine.cpp ../src/window.cpp ../src/entity.cpp ../src/renderer.cpp ../src/texture.cpp -I ../inc/engine -I ../inc/SDL
echo creating binary
@REM note: sdl works file with the -l in -lSDL2main and the sdl2 one... include -lib in -lSDL2main which makes it -libSDL2main.
g++ ../build/engine.o ../build/texture.o ../build/entity.o ../build/renderer.o ../build/window.o -o a.exe -L ../lib -lmingw32 -lSDL2main -lSDL2 -lSDL2_image
popd
